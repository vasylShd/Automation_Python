...
class DashBoardLocatorColection():
    def __init__(self):
        ...
        self.__registration_form = '//a[@class="header__auth_profile"]'
        self.__input_phone_field = '//input[@class="sign-in__input"]'
        self.__cancel_registration =  '//form[@id="popup-sign-in"]//div[@class="sign-in__btn2"]'
        ...
        self.__product_example_1 = '//a[@class ="product-card__layout-pic"][@href="/ua/art-p54030-brembo-217269"]'
        self.__buying_button = '//a[@class="card-price-box__btn button_buy article-page"]'
        self.__cart_open = '//div[@class="header__cart"]'
        self.__cart_close = '//*[@id="popup-cart"]/div/div[1]'

    @property
    def try_registration(self):
        return self.__registration_form, self.__input_phone_field, self.__cancel_registration
    ...
    def add_product_to_cart(self):
        return self.__buying_button, self.__product_example_1


    @property
    def cart_open_close(self):
        return self.__cart_open, self.__cart_close
